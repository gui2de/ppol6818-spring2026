...
* Peggy:
* I think your method is better than mine because your method is simpler 
* than mine. Through your method, I learned another solution to this problem.
...
* Peggy:
* For the second line of code, I got error code. It said:
* de q2_CIV_Section_0.dta
* factor-variable and time-series operators not allowed
* I don't think it is a big deal.
* For "replace department = lower(department)". I also got en error code and
* cannot move forward.
* Stata said:> replace department = lower(department)
*.             invalid 'replace' 
...
* Peggy:
* For the first line of code, I got an error. 
*. use q3_GPS_Data.dta, clear
*  file q3_GPS_Data.dta not found
* I think it should be: use "q3_GPS Data.dta"
* Also, in line 106, I got en error code.
* My Stata said: 
*. geodist lat lon clus_lat clus_lon, gen(distcent)
*. command geodist is unrecognized
* Because this error, I cannot move forward to check rest of your code. 
...
* Peggy:
* The code for this one run smoothly. I think my result is basically the same 
* as yours. I don't think there is anything wrong with this question.
...
* Peggy:
* The code for this question runs smoothly. My result is also similar to yours, 
* although the code looks a little different from yours. I think you did this 
* question correctly.
...
* Peggy:
* Line 311, I got an error code. My Stata said:
*. unique ward_15
*.  command unique is unrecognized
*.  r(199);
* My final result have 3944 observations.
* When I did merge 1:m ward_10 using `gis_15', keep(master match)
* I got number of obs for matched are 3216, and I got 331 not matched obs.
* For that 331 observations, I don't have any data about them except for 
* "region", "ward", "total_candidates", and "ward_total_votes".
