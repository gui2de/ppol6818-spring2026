...
set more off
cap log close
global class "/Users/gavinaligondalwala/Documents/Georgetown/Spring2026/ExperimentalDesign/ExpDesStata1/Stata1_Data"
...
use "$class/student.dta",clear

rename primary_teacher teacher

merge m:1 teacher using "$class/teacher.dta"
tab _merge
drop _merge

merge m:1 school using "$class/school.dta" 
tab _merge
drop _merge

merge m:1 subject using "$class/subject.dta"
tab _merge 
drop _merge

save "$class/q1_merge.dta",replace
...
use "$class/q5_Tz_student_roster_html.dta", clear
