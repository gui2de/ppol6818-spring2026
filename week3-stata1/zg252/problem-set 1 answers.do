...
//had to change the code below from replace to gen because it wasn't defined (Arishka)
gen village_pixel_class = 1 if pixel_village == 0
...
///(c)
gsort average_total_stand_score
gen rank = _n

//Question 4
global wd "C:\Users\arish\Desktop\McCourt\Spring 2026\Experimental Design"
*update the wd global so that it refers to the Box folder filepath on your machine

global excel_t21 "$wd\\Assignment 3\assignment_ Stata 1\q4_Pakistan_district_table21.xlsx"
...
generate student_group_lessthan40 = 1
