...
We see that as sample size increases, the value of our estimates (beta, SEM, ll. ul) decreasing is tightening around the true population value. 
The true population values is illustrated by n = 10,000. 
Conclusion: Higher sample size, the closer our estimate gets to the true population parameter. Our test is getting more precise.
...
In the same way that question 1's statistics get tighter and closer to 